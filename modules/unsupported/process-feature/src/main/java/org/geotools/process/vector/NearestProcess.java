...
public class NearestProcess implements VectorProcess {
    ...
    public FeatureCollection<?, ?> execute(
        ...
        try {
            ...
            NearestFeatureCollection results =
                    new NearestFeatureCollection(targetFeatureType, point, crsTransform, numFeatures);
    ...
    private static class NearestFeatureCollection extends AbstractFeatureCollection {
        ...
        protected NearestFeatureCollection(
                SimpleFeatureType schema, Geometry point, MathTransform crsTransform, int numFeatures) {
            super(schema);
            this.point = point;
    ...
    private static SimpleFeature createTargetFeature(
            Feature feature, SimpleFeatureType targetFeatureType, Geometry geom, Double nearestDistance)
            throws ProcessException {
        try {
